...
const ScemaSearchEngine = () => {
    return (
        <div className="min-h-screen flex flex-col bg-[#ECFEFF] dark:bg-gray-900">
            {/* Head Tag */}
            <HeadTag title="ScemaSearchEngine - Ukhang Marma" />
            ...
            <main className="mt-16 mb-14">
                <section className="md:max-w-xl max-w-lg mx-auto md:px-0 px-4 mt-24">
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-4 ml-2">
                        ...
                        <Link href="https://scema-search-engine.vercel.app/" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://scema-search-engine.vercel.app/</Link>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-1.5 ml-2">
                        ...
                        <span className="text-[#0F172A] dark:text-white flex flex-wrap items-center gap-2">
                            ...
                            <div className="flex gap-x-0.5 items-center">
                                <Image src="/images/tailwind-css.svg" className="w-[17px] h-[17px]" width={17} height={17} alt="react image"/>
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-1.5 ml-2">
                        ...
                        <Link href="https://github.com/Ukhang/scema-search-engine" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://github.com/Ukhang/scema-search-engine</Link>
                    </div>
...
export default ScemaSearchEngine;