            ...
            <main className="mt-16 mb-14">
                <section className="md:max-w-xl max-w-lg mx-auto md:px-0 px-4 mt-24">
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-4 ml-2">
                        ...
                        <Link href="https://numberconverter.vercel.app/" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://numberconverter.vercel.app/</Link>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-1.5 ml-2">
                        ...
                        <span className="text-[#0F172A] dark:text-white flex flex-wrap items-center gap-2">
                            <div className="flex gap-x-0.5">
                                <Image src="/images/react.svg" width={17} height={17} alt="react image"/>
                                <span>React,</span>
                            </div>
                            <div className="flex gap-x-0.5">
                            ...
                            <div className="flex gap-x-0.5">
                                <Image src="/images/tailwind-css.svg" width={17} height={17} alt="tailwindcss image"/>
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-1.5 ml-2">
                        ...
                        <Link href="https://github.com/Ukhang/Number-converter" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://github.com/Ukhang/Number-converter</Link>
                    </div>
