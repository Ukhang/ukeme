            ...
            <main className="mt-16 mb-14">
                <section className="md:max-w-xl max-w-lg mx-auto md:px-0 px-4 mt-24">
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-4 ml-2">
                        ...
                        <Link href="https://snake-game-mu-lovat.vercel.app/" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://snake-game-mu-lovat.vercel.app/</Link>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 items-center mt-1.5 ml-2">
                        ...
                        <Link href="https://github.com/Ukhang/Snake---Game" className="text-blue-600 dark:text-cyan-300 hover:underline" target="_blank">https://github.com/Ukhang/Snake---Game</Link>
                    </div>
