                ...
                <section className="md:max-w-xl max-w-lg mx-auto md:px-0 px-4 mt-24">
                    ...
                    <div className="grid sm:grid-cols-2 gap-8">
                        {WorkData.map((curVal) => (
                            ...
                            >
                                <Image src={curVal.img} alt={curVal.alt} width={544} height={319} className="rounded-[7px] w-full"/>
                                <div className="space-y-0.5">
                                    <h2 className="text-center font-semibold text-gray-800 dark:text-gray-200">{curVal.name}</h2>
                                    <p className="text-[15px] text-center">{curVal.subText}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <div className="mt-10">
                        ...
                        <div className="flex flex-wrap items-center gap-5 mt-1.5">
                            <FaGithub/>
                            <Link href="https://github.com/Ukhang" className="text-blue-700 dark:text-cyan-300 hover:underline" target="_blank">https://github.com/Ukhang</Link>
                        </div>
                    </div>
                </section>
            </main>
